 ...
 *
 * Handoff 2026-08-05: six quality improvements (logger injection, validation,
 * cache reset, dead-code removal). See LEDGER_HANDOFF_2026-08-05.md.
 */
...
export class LedgerTree {
  ...
  /** Route through injected logger when present; else console. */
   ...
   * Called internally during tree evolution.
   */
